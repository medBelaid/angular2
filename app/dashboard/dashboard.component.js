...
var DashboardComponent = (function () {
    function DashboardComponent(router, heroService, peopleService) {
        this.router = router;
    ...
    DashboardComponent = __decorate([
        core_1.Component({
            ...
            providers: [hero_service_1.HeroService, people_service_1.PeopleService],
            styleUrls: ['app/dashboard/dashboard.component.css']
        }), 
        __metadata('design:paramtypes', [router_1.Router, hero_service_1.HeroService, people_service_1.PeopleService])
    ], DashboardComponent);
